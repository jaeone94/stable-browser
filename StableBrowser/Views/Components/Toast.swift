...
class Toast {
    ...
    func present(title: String, symbol: String?, tint: Color = .primary, isUserInteractionEnabled: Bool = false, timing: ToastTime = .medium, padding: Double = 0.0) {
...
fileprivate struct ToastView: View {
    ...
    var body: some View {
        ...
        .transition(.offset(y: 150 + item.padding))
    }
