...
struct ResultImageView: View {
    var img2imgView: StableImg2ImgView
    var parent: ResultSection
    ...
    var body: some View {
        ...
        .sheet(isPresented: $isSavePhotoViewVisible) {
            SavePhotoView(image: resultImages[selectedImageIndex].image, sourceImage: sourceImage, additionalInfo: resultImages[selectedImageIndex].info)
        ...
        .alert(isPresented: $showAlert) {
            return Alert(
                ...
                primaryButton: .default(Text("Set")) {
                    img2imgView.baseImage = resultImages[selectedImageIndex].image
                    img2imgView.width = resultImages[selectedImageIndex].image.size.width
                    img2imgView.height = resultImages[selectedImageIndex].image.size.height
                    img2imgView.maskImage = nil
//                    img2imgView.resizeScale = 1.0
